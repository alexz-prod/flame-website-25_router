...
export default function () {
  return (
    <main className="content my-16 max-w-2xl">
      <h1 className="h2 mb-12">Impressum</h1>
      ...
      <p className="mb-6">
        Vereinsregister: VR 200278
        <br />
        Registergericht: Augsburg
      </p>
      <p className="mb-6">
        <h3 className="h3">Vertreten durch:</h3>
        Johannes Hartl (1. Vorsitzender)
        <br />
        Johannes Buggele (Kassenwart)
        <br />
        Petra Hardt
        <br />
      ...
      <h2 className="h3">EU-Streit&shy;schlichtung</h2>
      <p className="mb-6">
